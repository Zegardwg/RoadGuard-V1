        ...
        <div className="relative -mx-4 flex items-center justify-between">
          <div className="w-60 max-w-full px-4">
            <a href="index.html" className="navbar-logo block w-full py-5">
              {/* Uncomment and add your logo src if needed */}
              {/* <img src="logo.png" alt="logo" className="header-logo w-full" /> */}
            </a>
          </div>
            ...
            <div className="flex items-center justify-end pr-16 lg:pr-0">
              ...
              >
                ...
                <span className="block text-white dark:hidden">
                  ...
                  >
                    <path d="M13.3125 1.5C12.675 1.3125 12.0375 1.1625 11.3625 1.05C10.875 0.975 10.35 1.2375 10.1625 1.6875C9.9375 2.1375 10.05 2.7 10.425 3C13.0875 5.475 14.0625 9.1125 12.975 12.525C11.775 16.3125 8.25 18.975 4.1625 19.0875C3.6375 19.0875 3.225 19.425 3.075 19.9125C2.925 20.4 3.15 20.925 3.5625 21.1875C4.5 21.75 5.4375 22.2 6.375 22.5C7.4625 22.8375 8.5875 22.9875 9.7125 22.9875C11.625 22.9875 13.5 22.5 15.1875 21.5625C17.85 20.1 19.725 17.7375 20.55 14.8875C22.1625 9.2625 18.975 3.375 13.3125 1.5ZM18.9375 14.4C18.2625 16.8375 16.6125 18.825 14.4 20.0625C12.075 21.3375 9.4125 21.6 6.9 20.85C6.6375 20.775 6.3375 20.6625 6.075 20.55C10.05 19.7625 13.35 16.9125 14.5875 13.0125C15.675 9.5625 15 5.925 12.7875 3.075C17.5875 4.6875 20.2875 9.675 18.9375 14.4Z" />
                  </svg>
                </span>
                <span className="hidden text-white dark:block">
                  {/* Dark mode icon */}
                  {/* Add SVG for dark mode */}
                </span>
              </label>
              <div className="hidden sm:flex">
                ...
                <a
                  href="#"
                  className="signUpBtn rounded-md bg-white bg-opacity-20 px-4 py-2 text-base font-medium text-white hover:opacity-70"
                >
                  Sign Up
                </a>
              </div>
...
//             <div className="w-60 max-w-full px-4">
//               <a href="index.html" className="navbar-logo block w-full py-5">
//                   {/* <img src="" alt="logo" className="header-logo w-full" /> */}
//               </a>
//             </div>
//             <div className="flex w-full items-center justify-between px-4">
//               <div>
...
//                 <div className="mt-16">
//                   <img
//                     src="assets/images/about/Yolo.gif"
//                     alt="hero"
...
//                 </h4>
//                 <p className="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
//                   Akses ke data Anda dari mana saja, kapan saja
//                   Antarmuka yang intuitif dan mudah digunakan dengan dasbor yang dapat disesuaikan
//                 </p>
//                 <a
//                   href="javascript:void(0)"
//                   className="text-base font-medium text-dark hover:text-primary dark:text-white dark:hover:text-primary"
...
//                 </h4>
//                 <p className="mb-8 text-body-color dark:text-dark-6 lg:mb-9">
//                   Gunakan aplikasi pendamping untuk menyederhanakan penjadwalan dan penetapan tugas
//                   Kelola tugas pemeliharaan jalan dengan memantau peta insiden dan cetakannya
//                 </p>
//                 <a
//                   href="javascript:void(0)"
//                   className="text-base font-medium text-dark hover:text-primary dark:text-white dark:hover:text-primary"
...
//                   >
//                     RoadGuard merevolusi inspeksi jalan dan infrastruktur. Ditenagai oleh teknologi YOLO dan kamera AI mutakhir, aplikasi ini mengotomatiskan deteksi lubang jalan serta analisis data secara real-time, membuat pemantauan lebih mudah dan efektif.
//                     <br />
//                     <br />
...
//                     >
//                       <img
//                         src="./assets/images/about/Ipad.png"
//                         alt="about image"
...
//                   >
//                     "Coba demo aplikasi Road Guard sekarang dan rasakan kemudahan mendeteksi lubang jalan secara otomatis dengan teknologi AI!"
//                   </p>
//                   <a
//                     href="javascript:void(0)"
...
//                 >
//                   Berikut adalah pertanyaa Road Guard. Jika kamu memiliki pertanyaan lebih lanjut, silakan hubungi RoadGuard@gmail.com.
//                 </p>
//               </div>
//             </div>
//           </div>
...
//                     RoadGuard adalah aplikasi pintar yang menggunakan teknologi YOLO untuk mendeteksi lubang di jalan secara otomatis dan real-time. Aplikasi ini dirancang untuk membantu pemantauan dan perbaikan jalan dengan cepat, memastikan infrastruktur tetap aman dan terawat. RoadGuard juga dapat menyimpan data berupa foto dan laporan yang bisa diakses melalui dashboard online.
//                   </p>
//                 </div>
//               </div>
//               <div className="mb-12 flex lg:mb-[70px]">
...
//                     className="mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl"
//                   >
//                     Bagaimana cara memilih paket RoadGuard yang sesuai dengan kebutuhan saya?
//                   </h3>
//                   <p className="text-base text-body-color dark:text-dark-6">
//                     Apakah aplikasi akan digunakan di area dengan lalu lintas padat?
//                     Berapa sering Anda membutuhkan laporan kondisi jalan secara otomatis?</p>
//                   <p className="text-base text-body-color dark:text-dark-6">Apakah Anda memerlukan notifikasi langsung setiap ada kerusakan terdeteksi?
//                   </p>
//                 </div>
//               </div>
//             </div>
...
//                     className="mb-6 text-xl font-semibold text-dark dark:text-white sm:text-2xl lg:text-xl xl:text-2xl"
//                   >
//                     Saya belum paham tentang cara kerja aplikasi RoadGuard. Apa yang bisa saya lakukan?
//                   </h3>
//                   <p className="text-base text-body-color dark:text-dark-6">
//                     Jika Anda belum sepenuhnya memahami cara kerja RoadGuard, Anda bisa membaca informasi lebih lanjut di panduan penggunaan atau fitur aplikasi ini. Selain itu, Anda bisa menghubungi tim kami melalui fitur Live Chat atau WhatsApp di website untuk penjelasan lebih jelas dan bantuan sesuai kebutuhan Anda.
//                   </p>
//                 </div>
//               </div>
//               <div className="mb-12 flex lg:mb-[70px]">
...
//                   </h3>
//                   <p className="text-base text-body-color dark:text-dark-6">·{">"} Deteksi Real-Time: RoadGuard dapat mendeteksi lubang secara otomatis dengan akurasi tinggi menggunakan kamera AI.</p>
//                   <p className="text-base text-body-color dark:text-dark-6">·{">"} Laporan Otomatis: Aplikasi ini menyediakan laporan lengkap beserta foto bukti setiap kerusakan terdeteksi.</p>
//                   <p className="text-base text-body-color dark:text-dark-6">·{">"} Dashboard Interaktif: Semua data tersimpan dalam sistem dan bisa dipantau secara online kapan saja.</p>
//                 </div>
//               </div>
//             </div>
//         </div>
...
//             <a href="">
//               <img
//                 src="./assets/images/brands/download (1).png"
//                 alt="graygrids"
...
//             <a href="">
//               <img
//                 src="./assets/images/brands/download (2).png"
//                 alt="lineicons"
//                 className="dark:hidden" />
//               <img
//                 src="./assets/images/brands/download (2).png"
...
//             <a href="">
//               <img
//                 src="./assets/images/brands/download (3).png"
//                 alt="uideck"
//                 className="dark:hidden" />
//               <img
//                 src="./assets/images/brands/download (3).png"
...
//             <a href="">
//               <img
//                 src="./assets/images/brands/download (4).png"
//                 alt="ayroui"
//                 className="dark:hidden" />
//               <img
//                 src="./assets/images/brands/download (4).png"
...
//             <a href="">
//               <img
//                 src="./assets/images/brands/download (6).png"
//                 alt="tailgrids"
//                 className="dark:hidden" />
//               <img
//                 src="./assets/images/brands/download (6).png"
...
//           ></span>
//         </a><script src="assets/js/swiper-bundle.min.js"></script><script src="assets/js/main.js"></script><script>
//       // ==== for menu scroll
//           const pageLink = document.querySelectorAll(".ud-menu-scroll");

//           pageLink.forEach((elem) ={">"} {elem.addEventListener("click", (e) => {
//             e.preventDefault();
...
//           {"}"} else {currLink.classNameList.remove("active")};
//           {"}"}
//           {"}"}
//           {"}"}
...
//           // Testimonial
//           const testimonialSwiper = new Swiper(".testimonial-carousel", {slidesPerView}: 1,
//           spaceBetween: 30,
